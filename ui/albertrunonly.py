...
Original file is located at
    https://colab.research.google.com/drive/1oqE_ZT2JJ8jt0zlME5dl3KChGp0S-A0w
"""
...
def create_model():
    ...
    encoder = TFAlbertModel.from_pretrained(save_path+"/")
...
# tokenizer = AlbertTokenizerFast.from_pretrained(save_path, do_lower_case=False, keep_accents=True) #path to a directoy istiyor
tokenizer = AlbertTokenizerFast.from_pretrained(save_path, do_lower_case=False, keep_accents=True) #path to a directoy istiyor
# tokenizer = AlbertTokenizerFast(vocab_file=save_path+"/vocab.txt", do_lower_case=False, keep_accents=True)

model = create_model()
# model.summary()

model.load_weights(save_path + "/weights/" + "loodos-albert-base-turkish-uncased" + "_seqlen512_batch64_epochs10_weights.h5")
